...
public class MyBatisGenerator {
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
        ...
        String mainTypes = configuration.getContexts().get(0).getProperties().getProperty("mainType");
        boolean mainType = false;
        if (mainTypes != null && mainTypes.equalsIgnoreCase("true")) {
        	mainType = true;
        }
        ...
        for (GeneratedXmlFile gxf : generatedXmlFiles) {
            ...
            try {
            	File directory = null;
            	if (mainType) {
            		directory = shellCallback.getDirectory(projectPath + gxf
            				.getTargetProject(), defaultPackage + gxf.getTargetPackage());
            	} else {
            		directory = shellCallback.getDirectory(gxf
...
//                        .getTargetProject(), defaultPackage + gjf.getTargetPackage());
            	File directory = null;
            	if (mainType) {
            		directory = shellCallback.getDirectory(projectPath + gjf
            				.getTargetProject(), defaultPackage + gjf.getTargetPackage());
            	} else {
            		directory = shellCallback.getDirectory(gjf
